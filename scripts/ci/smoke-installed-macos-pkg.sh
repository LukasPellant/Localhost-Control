...
smoke_browser_native() {
  ...
  pnpm smoke:browser-native -- --browser "${browser}" --headless "${required_args[@]}" "${installed_host_args[@]}" --host-path "/Library/Application Support/Localhost Control/localhost-control-host"
}
